...
When applying the Akaike information criterion (AIC), we noticed that AIC(8582.95) of the third model is lower than that(8585.36) of the full model by about 3. Bayesian information criterion (BIC) also favors model 3, the small model.
