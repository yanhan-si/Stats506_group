...
We performed backward elimination to reduce the complexity of the model. We first removed `CreditScore`, `Balance`and  `EstimatedSalary` from the model and refit the model.
...
We thank EunSeon Ahn and Erin Susan Cikanek for helpful and constructive feedback.
